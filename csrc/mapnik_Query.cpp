 ...
 */
JNIEXPORT jlong JNICALL Java_mapnik_Query_alloc(JNIEnv *env, jclass c, jobject bboxj, jdouble resx, jdouble resy,
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_mapnik_Query_dealloc(JNIEnv *env, jobject, jlong ptr) {
    PREAMBLE;
