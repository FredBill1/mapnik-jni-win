...
inline void init_class(JNIEnv* env, const char* name, jclass& classref) {
...
inline jfieldID lookup_field(JNIEnv* env, jclass c, const char* name, const char* sig) {
...
inline jmethodID lookup_method(JNIEnv* env, jclass c, const char* name, const char* sig) {
...
inline jmethodID lookup_static_method(JNIEnv* env, jclass c, const char* name, const char* sig) {
...
inline bool init_ids(JNIEnv* env) {
    mapnik::setup();
